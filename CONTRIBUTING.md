...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin) and clone your fork
locally.
...
```sh
$ git remote add upstream https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin
```
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/solace-sdkperf-amqp-plugin/issues/new) and describe the new functionality.
